						...
						<ul class="nav">
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									...
									<span class="avatar country-Flag mr-0 align-self-center bg-transparent text-muted"><i class="far fa-flag"></i></span>
									</a>
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										<a href="{{ LaravelLocalization::getLocalizedURL('en') }}" class="dropdown-item d-flex ">
											<span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('dashboard/assets/img/flags/us_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2">English</span>
											</div>
										</a>
										<a href="{{ LaravelLocalization::getLocalizedURL('ar') }}" class="dropdown-item d-flex">
											<span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('dashboard/assets/img/flags/egypt_flag.png')}}" alt="img"></span>
											<div class="d-flex">
